...
import com.trusthiker.common.db.dao.complexQuery.NoValueQueryParam;
import com.trusthiker.common.db.dao.complexQuery.Sort;
import com.trusthiker.common.db.dao.complexQuery.WithValueQueryParam;
import com.trusthiker.common.db.dao.impl.mybatis.modelParser.ColumnTarget;
...
//                i++;
    ...
    private String parseIdColumn() {
        String idColumn = "ID";
        try {
            Method getIdMethod = modelClass.getMethod("getId", Object.class);
